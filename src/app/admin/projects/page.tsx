      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {items.length > 0 ? (
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-semibold text-gray-700">Год</th>
            ...
            <tbody>
              {items.map((item) => (
                <tr key={item.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-gray-500 text-xs whitespace-nowrap">{item.year || "—"}</td>
          ...
          <div className="text-center py-16">
            ...
            <Link href="/admin/projects/new" className="inline-flex items-center gap-2 bg-red-800 text-white text-sm px-4 py-2 rounded-lg">
              + Создать проект
            </Link>
          </div>
        )}
