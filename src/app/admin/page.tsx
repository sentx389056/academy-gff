    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { label: "Сотрудников", value: staffCount, href: "/admin/staff", color: "bg-red-600" },
          { label: "Заявки", value: applicationsCount, href: "/admin/applications", color: "bg-purple-600" },
        ].map((stat) => (
          <Link key={stat.label} href={stat.href}>
            <div className="bg-white rounded-sm p-6 border border-gray-200 hover:shadow-md transition-shadow flex items-center gap-4">
